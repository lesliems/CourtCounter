...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        red = (EditText)findViewById(R.id.teamPlatnium);

        blue = (EditText)findViewById(R.id.teamBlue);

        gameOver = new AlertDialog.Builder(MainActivity.this).create();

       //for mussiiccc soundFX1 = MediaPlayer.create(this, //R.raw.up);
       //for musiiccc soundFX2 = MediaPlayer.create(this, // R.raw.down);
        // formusic     soundFX3 = MediaPlayer.create(this, //R.raw.reset);
    }
